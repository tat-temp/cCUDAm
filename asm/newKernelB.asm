...
FUNCTION SaveRegAB(Ind=Rt0)
{
    ...
    [B------:R-:W-:-:S05]    SHF.R.U32.HI Ind, RZ, 0x13, Ind
    [B------:R-:W-:-:S05]    IMAD.U32 Ind, Ind, 0xFFFFFFF6, RCurB
...
ind_LastPnts=Rt12, var=Rt13, ind=Rt14, pos=Rt18, rx=Rt20)
{
    ...
    [B------:R-:W5:-:S02] @P3 ATOMG.E.EL.ADD.STRONG_GPU PT, ind, [kang_indAF.U32 + DPTableBase], TenTh
    ...
    [B----4-:R-:W-:Y:S13] @P4 ISETP.NE.AND P5, PT, RZ, RZ, !PT
    ...
    [B------:R-:W5:-:S02] @P3 ATOMG.E.EL.ADD.STRONG_GPU PT, ind, [kang_indBF.U32 + DPTableBase], TenTh
    [B-----5:R-:W-:-:S06]    SHF.R.U32.HI ind, RZ, 0x10, ind
    [B------:R-:W-:Y:S13]    ISETP.LT.AND P3, PT, ind, {DPTABLE_MAX_CNT}, P3
    ...
    [B------:R4:W-:-:S02] @P4 STG.E [ind.U32 + LoopedKangsBase + 0x08], ind_LastPnts
    [B----4-:R-:W-:Y:S13] @P4 ISETP.NE.AND P6, PT, RZ, RZ, !PT
}
...
#IF {SM_VER} == 89
    ...
    [B------:R-:W-:-:S01]    ULDC.64 DPsBase, c[0x0][0x1B8]
    [B------:R-:W-:-:S01]    ULDC.64 LoopTableBase, c[0x0][0x1C0]
    [B------:R-:W-:-:S01]    ULDC.64 LoopedKangsBase, c[0x0][0x1C8]
    [B------:R-:W-:-:S01]    ULDC.64 distsBase, c[0x0][0x1D0]
    [B------:R-:W-:-:S01]    ULDC.64 JmpDists12Base, c[0x0][0x1D8]
...
#ELSE
    ...
    [B------:R-:W0:-:S01]    LDCU.64 DPsBase, c[0x0][{0x1B8 + 0x220}]
    [B------:R-:W0:-:S01]    LDCU.64 LoopTableBase, c[0x0][{0x1C0 + 0x220}]
    [B------:R-:W0:-:S01]    LDCU.64 LoopedKangsBase, c[0x0][{0x1C8 + 0x220}]
    [B------:R-:W0:-:S01]    LDCU.64 distsBase, c[0x0][{0x1D0 + 0x220}]
    [B------:R-:W0:-:S01]    LDCU.64 JmpDists12Base, c[0x0][{0x1D8 + 0x220}]
...
.main_loop_beg:
    [B------:R-:W-:-:S01]    IMAD.U32 TmpA, BlockID, {MD_LEN * 256 * GROUP_SIZE * 8}, RZ
    [B------:R-:W-:-:S05]    MOV TmpB, {2 * MD_LEN * 256 * 8}
