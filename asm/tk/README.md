...
exactly the fourteen `FUNCTION`s `main.asm` reaches — `Copy256`, `SubMod256`,
`SubMod256_3`, `NegMod256`, `MulMod256`, `SqrMod256`, `InvMod256` and its seven `_`-prefixed
helpers — and leaves out `MadMod256`, `SqrAddMod256`, `AddMod256` and `Zero256`, which
nothing calls.
...
### The eight copies go through `Copy256`
