FUNCTION getPublish2(ext=Ri0, bdone=Ri1, bsz=Ri2, gid=Ri3, uGD=URt0, frp=Rt0, sadr=Rt2, scal=Rt4, czero=Rt12, cret=Rt13, cadr=Rt14, newv=Rt16, prod=Rt18, sgn=Rt20)
{
    ...
    [B-1----:R-:W-:-:S04]      IMAD.WIDE.U32 sadr0, gid, 0x20, sadr0
    ...
    [B------:R-:W-:-:S04]      IADD3 prod0, Pt2, PT, prod0, ext, RZ
    [B------:R-:W-:-:S04]      IADD3.X prod1, PT, PT, prod1, sgn, RZ, Pt2, !PT
    [B------:R-:W-:-:S04]      SHF.R.S32.HI sgn, RZ, 0x1f, prod1 //scal += sign-extended delta
    [B--2---:R-:W-:-:S04]      IADD3 scal0, Pt2, PT, scal0, prod0, RZ
    [B------:R-:W-:-:S04]      IADD3.X scal1, Pt2, PT, scal1, prod1, RZ, Pt2, !PT
    [B------:R-:W-:-:S04]      IADD3.X scal2, Pt2, PT, scal2, sgn, RZ, Pt2, !PT
    [B------:R-:W-:-:S04]      IADD3.X scal3, Pt2, PT, scal3, sgn, RZ, Pt2, !PT
    [B------:R-:W-:-:S04]      IADD3.X scal4, Pt2, PT, scal4, sgn, RZ, Pt2, !PT
    [B------:R-:W-:-:S04]      IADD3.X scal5, Pt2, PT, scal5, sgn, RZ, Pt2, !PT
    [B------:R-:W-:-:S04]      IADD3.X scal6, Pt2, PT, scal6, sgn, RZ, Pt2, !PT
