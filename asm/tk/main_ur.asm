...
// RCAsm encodes URZ as UR63, which on Blackwell is a REAL register, so every URZ
// source below (UIADD3, USHF) would otherwise read whatever it holds. Zero it once.
...
// The same value on the uniform side: batch_size * 16. Barrier 5 is the one the Half
// load already uses, and a wait on it drains both.
